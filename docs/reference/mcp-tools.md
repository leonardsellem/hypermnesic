...
wikilinking an entity. The owner-facing daily workflow dashboard is generated by the local
`hypermnesic daily-review` CLI command; it does not add an MCP tool.
