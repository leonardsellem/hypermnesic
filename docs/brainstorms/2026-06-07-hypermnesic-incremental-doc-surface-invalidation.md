...
Source inspected in `/home/ubuntu/.hermes/plugins/hypermnesic` on `main` with a clean worktree.
...
Run `/ce-plan` to turn this into an implementation plan against `/home/ubuntu/.hermes/plugins/hypermnesic`, with a TDD sequence:
